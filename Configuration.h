...
#define X_ENDSTOP_OFFSET -0.2
#define Y_ENDSTOP_OFFSET -0.52
#define Z_ENDSTOP_OFFSET -0.83
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 211.06 // For delta: Distance between nozzle and print surface after homing.
#endif
