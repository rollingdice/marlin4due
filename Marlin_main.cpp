...
// Extruder offsets
  ...
  // In quadrant III, cos (210) = -sin(60).
  //                  sin (210) = -cos(60).
  // In Q4, cos(330) = sin(60).
  //        sin(330) = -cos(60).
  float delta_radius = DELTA_RADIUS;
  float delta_tower1_x = COS_A * delta_radius; // front left tower
  float delta_tower1_y = SIN_A * delta_radius;     
  float delta_tower2_x = COS_B * delta_radius; // front right tower
  float delta_tower2_y = SIN_B * delta_radius;     
