...
#ifdef DUE_FLASH_STORAGE
#include <DueFlashStorage.h>
#endif //DUE_FLASH_STORAGE
// --------------------------------------------------------------------------
// Externals
// --------------------------------------------------------------------------
...
void eeprom_write_byte(unsigned char *pos, unsigned char value)
{
  unsigned flash_address = (unsigned) pos;
  dueFlashStorage.write (flash_address, value);
}
unsigned char eeprom_read_byte(unsigned char *pos)
{
  unsigned flash_address = (unsigned) pos;
  return dueFlashStorage.read(flash_address);
}
#endif //DUE_FLASH_STORAGE
// --------------------------------------------------------------------------
// Timers
